...
STATE_TECHNICAL_SANCTIONED = "TECHNICAL_SANCTIONED"
STATE_ADMIN_SANCTIONED = "ADMIN_SANCTIONED"
STATE_UNDER_SCRUTINY = "UNDER_SCRUTINY"
...
RECOMMENDATION_TRANSITIONS: Dict[str, Set[str]] = {
    ...
    STATE_SUBMITTED: {STATE_DISTRICT_REVIEW, STATE_TECHNICAL_SANCTIONED, STATE_RETURNED_FOR_CORRECTION, STATE_REJECTED, STATE_DRAFT},
    STATE_DISTRICT_REVIEW: {STATE_TECHNICAL_SANCTIONED, STATE_STATE_REVIEW, STATE_RETURNED_FOR_CORRECTION, STATE_REJECTED},
    STATE_TECHNICAL_SANCTIONED: {STATE_STATE_REVIEW, STATE_ADMIN_SANCTIONED, STATE_SANCTIONED, STATE_IN_PROGRESS, STATE_REJECTED},
    STATE_RETURNED_FOR_CORRECTION: {STATE_DRAFT, STATE_SUBMITTED},
    STATE_STATE_REVIEW: {STATE_ADMIN_SANCTIONED, STATE_UNDER_SCRUTINY, STATE_SANCTIONED, STATE_REJECTED, STATE_DISTRICT_REVIEW},
    STATE_UNDER_SCRUTINY: {STATE_ADMIN_SANCTIONED, STATE_SANCTIONED, STATE_REJECTED},
    STATE_ADMIN_SANCTIONED: {STATE_SANCTIONED, STATE_IN_PROGRESS, STATE_REJECTED},
...
TRANSITION_AUTHORITY: Dict[Tuple[str, str], Set[str]] = {
    ...
    (STATE_SUBMITTED, STATE_TECHNICAL_SANCTIONED): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_SUBMITTED, STATE_RETURNED_FOR_CORRECTION): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_SUBMITTED, STATE_REJECTED): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_DISTRICT_REVIEW, STATE_TECHNICAL_SANCTIONED): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
    ...
    (STATE_DISTRICT_REVIEW, STATE_REJECTED): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_RETURNED_FOR_CORRECTION, STATE_DRAFT): {ROLE_MP},
    (STATE_RETURNED_FOR_CORRECTION, STATE_SUBMITTED): {ROLE_MP},
    (STATE_TECHNICAL_SANCTIONED, STATE_STATE_REVIEW): {ROLE_DISTRICT_AUTHORITY, ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_TECHNICAL_SANCTIONED, STATE_ADMIN_SANCTIONED): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_TECHNICAL_SANCTIONED, STATE_SANCTIONED): {ROLE_DISTRICT_AUTHORITY, ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_TECHNICAL_SANCTIONED, STATE_IN_PROGRESS): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_TECHNICAL_SANCTIONED, STATE_REJECTED): {ROLE_DISTRICT_AUTHORITY, ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_STATE_REVIEW, STATE_ADMIN_SANCTIONED): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_STATE_REVIEW, STATE_UNDER_SCRUTINY): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    ...
    (STATE_STATE_REVIEW, STATE_DISTRICT_REVIEW): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_UNDER_SCRUTINY, STATE_ADMIN_SANCTIONED): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_UNDER_SCRUTINY, STATE_SANCTIONED): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_UNDER_SCRUTINY, STATE_REJECTED): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_ADMIN_SANCTIONED, STATE_SANCTIONED): {ROLE_STATE_NODAL_AUTHORITY, ROLE_MINISTRY_ADMIN},
    (STATE_ADMIN_SANCTIONED, STATE_IN_PROGRESS): {ROLE_DISTRICT_AUTHORITY, ROLE_MINISTRY_ADMIN},
