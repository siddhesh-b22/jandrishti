            ...
            {transactions.map((tx) => (
              ...
              >
                <div className="flex items-center justify-between text-xs text-slate-500 font-mono">
                  ...
                  <span className="text-[10px] text-slate-400">Voucher #{tx.internal_transaction_id}</span>
                </div>
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-xs">
                  <div>
                    <span className="block font-medium text-slate-800">{tx.constituency_normalized || tx.state_normalized}</span>
                    <span className="text-[10px] text-slate-500">MP: {tx.mp_name_normalized || tx.state_normalized}</span>
                  </div>
